...
Tracer.prototype.onEntry = function(args) {
	...
	// console.log('onEntry', this.stack)
	...
	return {name: args.name, file: args.file, fnLine: args.line, ts: Date.now(), stackId: sid, stack: JSON.stringify(this.stack.extMap)};
};
...
Tracer.prototype.onExit = function(args) {
	...
	// console.log('args.entryData.stackId', args.entryData.stackId)
	// console.log('onExit', args.entryData.stack)
	this.onExitArgs.ext = JSON.parse(args.entryData.stack)[args.entryData.stackId] || {}
...
Tracer.prototype.pushFrame = function(stackFrame) {
	...
	this.stack.extMap[stackId] = this.ext || {}
...
Tracer.prototype.mixinExt = function (ext) {
	this.ext = ext;
}
